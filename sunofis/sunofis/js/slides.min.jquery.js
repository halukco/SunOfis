...
if(option.generateNextPrev){$('.'+option.container,elem).after('<a href="#" id="aprev" class="'+option.prev+'">Prev</a>');$('.'+option.prev,elem).after('<a id="anext" href="#" class="'+option.next+'">Next</a>');}
