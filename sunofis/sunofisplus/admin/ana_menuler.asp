...
<table border="0" width="95%" cellpadding="2" align="center">
	...
	<tr>
		<td bgcolor="#efefef" width="50%"><font size="4"><b>Kurumsal</b></font></td>
		<td bgcolor="#efefef" width="50%">
		<b>
...
<table border="0" width="95%" cellpadding="2" align="center">
	...
	<tr>
		<td bgcolor="#efefef" width="50%"><font size="4"><b>Galeri</b></font></td>
		<td bgcolor="#efefef" width="50%">
		<b>
...
<table border="0" width="95%" cellpadding="2" align="center">
	...
	<tr>
		<td bgcolor="#efefef" width="50%"><font size="4"><b>SSS</b></font></td>
		<td bgcolor="#efefef" width="50%">
		<b>
...
%>
	<form action="ana_menuler.asp?islem=menuDuzenleSub&id=<% =solMenuList("id") %>" method="POST">
		...
		<a href="altmenuresimler.asp?id=<% =solMenuList("id") %>"><img src="images/mn_image.gif" border="0"></a> 
		TR:<input type="text" name="menu_adi" size="23" value="<% =solMenuList("menu_adi")  %>" style="font-weight:Bold;"> 
		Haberde Video Var:<input type="checkbox" name="sssvideo" value="1" <% if solMenuList("sssvideo") = "1" then %>checked<% end if %>>
...
<table border="0" width="95%" cellpadding="2" align="center">
	...
	<tr>
		<td bgcolor="#efefef" width="50%"><font size="4"><b>Hizmetlerimiz</b></font></td>
		<td bgcolor="#efefef" width="50%">
		<b>
...
if request.form("sssvideo") = "1" then 
menuDuzenle("sssvideo") = "1"
Else
menuDuzenle("sssvideo") = "0"
End if
